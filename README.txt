...
Die Aufgabenstellung des Coding-Contest (04.04. - 06.05.2012) habe ich für mich so interpretiert, dass eine Digitale Bibliothek (bzw. Online-Bibliothek) gefordert ist, an der sich User anmelden/ einloggen, nach Büchern recherchieren und diese für einen Geldbetrag/ Tag ausleihen können. Ein oder mehrere Administrato/ren verwalten den Buchbestand und die User. Die Preise/ Tag sind fiktiv.
...
Um sich zu registrieren muss der Offline-User ein Formular ausfüllen sowie seine E-Mail Adresse per Link bestätigen.
...
global 
	class_functions.inc.php	// Hilfsfunktionen (Datumsformatierungen, Blätterfunktionen, etc.)
